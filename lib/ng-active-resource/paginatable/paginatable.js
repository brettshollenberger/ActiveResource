  ...
  function(mixin, FunctionalCollection, Eventable) {
    ...
    function Paginatable() {
      ...
      this.paginate = function(paginationOptions) {
        ...
        if (options.preload) {
          this.preload(paginationHypermedia.previous);
          this.preload(paginationHypermedia.next);
        }
      }
      ...
      this.preload = function(hypermedia) {
        this.where(hypermedia.params, {preload: true});
      }
