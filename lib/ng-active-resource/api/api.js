...
angular
  ...
  .factory('ARAPI.Configuration', [function() {
    function APIConfiguration() {}

    APIConfiguration.prototype.baseURL      = "http://api.override.com";
    APIConfiguration.prototype.appendFormat = true;
    APIConfiguration.prototype.format       = "application/json";

    return APIConfiguration;
  }])

  .factory('ARAPI', ['ARAPI.Configuration', 'ARQueryString', 'ARMime', 
    function(APIConfiguration, querystring, Mime) {
    ...
    API.configure     = function(configurationFn) {
      return configurationFn(APIConfiguration.prototype);
    }
