...
angular
  ...
  'ARValidatable', 'ARPrimaryKey', 'ARWatchable', 'ARAPI', 'ARAssociatable', 'ARCacheable',
  ...
  function(Eventable, Creatable, Updatable, Saveable, Queryable, Findable, Deletable, Serializable,
    Deserializable, Validatable, PrimaryKey, Watchable, API, Associatable, Cacheable, Formattable,
    Errorable, Definable, ComputedProperty, Functional, Promiseable, Reflections) {
