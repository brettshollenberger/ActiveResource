...
angular
  ...
  'ARReflections.AbstractReflection', 'ARReflections.HasManyReflection', 
  ...
  function(mixin, FunctionalCollection, AbstractReflection, HasManyReflection, BelongsToReflection) {
    ...
    Reflections.included = function(klass) {
      ...
      klass.reflectOnAllAssociations = function(macro) {
        if (!_.isString(macro)) { return klass.reflections; }

        return klass.reflections.select(function(reflection) { return reflection.macro == macro; })
