(function() {
  ...
  angular
    ...
    .factory('BCMime', ['BCMime.Format', 'BCMime.Type', 'BCMime.parse',
      'BCSet',
    ...
    .factory('BCMime.parse', ['BCStrictRequire', function(strictRequire) {
      ...
      function getParsers(type) {
        ...
        var format   = getFormat(mimetype);
        return format !== undefined ? _.flatten([format.parsers, mimetype.parsers]) : mimetype.parsers;
      };

      function getMimetype(type) {
        return Mime.types.find(type);
      };

      function getFormat(mimetype) {
        return Mime.formats.find(mimetype.suffix) || Mime.formats.find(mimetype.subtypeName)
      };
