  ...
  function (mixin, FunctionalCollection, foreignkeyify) {
    QueryCache.included = function (klass) {
      ...
      function removeInstanceFromInappropriateQueries(instance) {
        _.chain(klass.queryCache).transform(function (selected, cachedCollection, cacheKey) {
    ...
    function instanceBelongsInCachedQuery(keyified, cacheKey) {
      ...
      return _.all(cacheKey, function (value, key) {
        return String(keyified[key]) == String(value);
      });
    }
    return QueryCache;
  }
...
angular.module('ngActiveResource').factory('ARQueryable', [
  ...
  'ARHTTPConfig',
  'ARQueryCache',
  function ($http, mixin, FunctionalCollection, Promiseable, HTTPResponseHandler, httpConfig, QueryCache) {
    ...
    function Queryable() {
      ...
      this.where = function (terms, config) {
        ...
        function returnCached() {
          ...
          _.each(cached, function (instance) {
            queryResults.push(instance);
          });
          queryResults.defer();
