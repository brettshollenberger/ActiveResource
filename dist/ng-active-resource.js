...
angular.module('ngActiveResource').factory('ARHeaders', [
  'ARMixin',
  'ARFunctional.Collection',
  function (mixin, FunctionalCollection) {
    return {
...
angular.module('ngActiveResource').factory('ARLinkHeaders', [
  'ARHeaders',
  'ARMixin',
  'ARFunctional.Collection',
...
angular.module('ngActiveResource').factory('ARHTTPResponseHandler', [
  ...
  function (strictRequire, Headers, LinkHeaders) {
    function HTTPResponseHandler(options) {
      ...
      this.headers = Headers.parse(options.headers || function () {
        return {};
      });
...
angular.module('ngActiveResource').factory('ARPaginatable', [
  ...
  function (mixin, FunctionalCollection) {
    function Paginatable() {
      var options = {}, mostRecentCall = {}, paginationHypermedia;
