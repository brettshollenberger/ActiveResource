describe("ARValidatable", function() {

  var Validatable, Validator, Validation;
  beforeEach(inject(["ARValidatable", "ARValidatable.Validator", "ARValidatable.Validation",
  function(_ARValidatable_, _ARValidator_, _ARValidation_) {
    Validatable = _ARValidatable_;
    Validator   = _ARValidator_;
    Validation  = _ARValidation_;
  }]));
